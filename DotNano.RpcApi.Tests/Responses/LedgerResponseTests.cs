...
namespace DotNano.RpcApi.Tests.Responses
{
    public class LedgerResponseTest
    {
        ...
        LedgerResponse _responseObject;
        private void CreateResponseObject()
        {
            _responseObject = JsonConvert.DeserializeObject<LedgerResponse>(_json, JsonSerializationSettings.PascalCaseSettings);
        }
    ...
    public class LedgerResponseTest1
    {
