...
namespace DotNano.RpcApi.Tests.Responses
{
    public class AccountsPendingResponseTest
    {
        ...
        AccountsPendingBasicResponse _responseObject;
        private void CreateResponseObject()
        {
            _responseObject = JsonConvert.DeserializeObject<AccountsPendingBasicResponse>(_json, JsonSerializationSettings.PascalCaseSettings);
        }
    ...
    public class AccountsPendingResponseTest1
    {
        ...
        AccountsPendingResponse _responseObject;
        private void CreateResponseObject()
        {
            _responseObject = JsonConvert.DeserializeObject<AccountsPendingResponse>(_json, JsonSerializationSettings.PascalCaseSettings);
        }
    ...
    public class AccountsPendingResponseTest2
    {
